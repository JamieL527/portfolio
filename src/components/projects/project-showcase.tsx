          ...
          {props.projects.map((proj) => (
            ...
            >
              <div className="flex gap-2">
                <span className="text-xs font-semibold text-accent transition-colors duration-300 sm:text-xs md:text-xl lg:hidden">
                  {proj.index + 1}.
                </span>
                <span
                  key={proj.title}
                  className="-underline-offset-1 text-2xl font-semibold text-accent underline transition-colors duration-300 sm:text-xl md:text-xl lg:hidden"
                >
                  {proj.title}
                </span>
              </div>
