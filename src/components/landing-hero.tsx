        ...
        <div className="mx-auto max-w-7xl">
          <AnimatePresence>
            ...
            <FadeUp key="description" duration={0.6} delay={0.2}>
              ...
              Explore the professional portfolio of Jiangyang Liu, a skilled Full Stack Developer with 4 years of experience in building web and AI-driven applications. 
              </div>
            </FadeUp>
          </AnimatePresence> 
